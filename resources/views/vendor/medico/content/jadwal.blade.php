   ...
   <section id="jadwal" class="faq ">
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2>Jadwal Dokter</h2>
            <p>Perlu diingat bahwa jadwal dokter dapat berubah sewaktu-waktu. Kami akan berusaha memberitahu Anda jika
                terjadi perubahan yang memengaruhi janji temu Anda. Terima kasih atas pemahaman Anda.</p>
        </div>
        <ul class="faq-list">
            @php
