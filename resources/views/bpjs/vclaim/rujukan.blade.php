            ...
            <x-adminlte-card theme="primary" theme-mode="outline">
                <form action="" method="get">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <x-adminlte-button theme="success" class="btn-sm" label="Buat Rujukan Keluar"
                ...
                @php
                    $heads = ['Tgl Rujukan', 'No Rujukan', 'Nama', 'No BPJS', 'Jns Pelayanan', 'PPK Dirujuk', 'No SEP'];
                    $config['scrollX'] = true;
                @endphp
                    ...
                    @if (isset($rujukans))
                        @foreach ($rujukans as $item)
                            <tr>
                                ...
                                <td>{{ $item->ppkDirujuk }} {{ $item->namaPpkDirujuk }}</td>
                                <td>{{ $item->noSep }}</td>
                                {{-- <td>
