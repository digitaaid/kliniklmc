                ...
                <div class="gallery-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-1.jpg"><img src="medicio/assets/img/gallery/gallery-1.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-2.jpg"><img src="medicio/assets/img/gallery/gallery-2.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-3.jpg"><img src="medicio/assets/img/gallery/gallery-3.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-4.jpg"><img src="medicio/assets/img/gallery/gallery-4.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-5.jpg"><img src="medicio/assets/img/gallery/gallery-5.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-6.jpg"><img src="medicio/assets/img/gallery/gallery-6.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-7.jpg"><img src="medicio/assets/img/gallery/gallery-7.jpg"
                                    class="img-fluid" alt=""></a></div>
                        <div class="swiper-slide"><a class="gallery-lightbox"
                                href="medicio/assets/img/gallery/gallery-8.jpg"><img src="medicio/assets/img/gallery/gallery-8.jpg"
                                    class="img-fluid" alt=""></a></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
