<div class="card card-info mb-1">
    <a class="card-header" data-toggle="collapse" data-parent="#accordion" href="#collKunj">
        ...
        <div class="card-tools">
            <button type="button" onclick="modalKunjungan()" class="btn btn-tool bg-warning">
            ...
            @else
                <button type="button" class="btn btn-tool bg-danger">
                    <i class="fas fa-times"></i> Belum Kunjungan
                </button>
            @endif
        </div>
    </a>
...
<x-adminlte-modal id="modalKunjungan" icon="fas fa-user-injured" title="Kunjungan Pasien" theme="success"
    icon="fas fa-file-medical" size="xl">
    <form action="{{ route('editkunjungan') }}" id="formKunjungan" method="POST">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <x-adminlte-input fgroup-class="col-md-6" name="kodekunjungan" label="Kode Kunjungan"
                        igroup-size="sm" placeholder="Kode Kunjungan" readonly
                        value="{{ $antrian->kunjungan->kode ?? null }}" enable-old-support />
                    <x-adminlte-input fgroup-class="col-md-6" name="counter" label="Counter Kunjungan" igroup-size="sm"
                        placeholder="Counter Kunjungan" value="{{ $antrian->kunjungan->counter ?? null }}"
                        enable-old-support readonly />
                    @php
                        $config = ['format' => 'YYYY-MM-DD HH:mm:ss'];
                    @endphp
                    <x-adminlte-input-date fgroup-class="col-md-6" name="tgl_masuk" igroup-size="sm"
                        label="Tanggal Masuk" enable-old-support placeholder="Tanggal Masuk" :config="$config"
                    ...
                    <x-adminlte-select igroup-size="sm" fgroup-class="col-md-6" name="jaminan" label="Jaminan Pasien"
                        enable-old-support>
                ...
                <hr>
                <div class="row">
                    <x-adminlte-input name="nomorkartu" class="nomorkartu-id" enable-old-support fgroup-class="col-md-6"
                    ...
                    <x-adminlte-input name="kelas" enable-old-support
                        value="{{ $antrian->kunjungan->kelas ?? null }}" class="kelas-id" label="Kelas Pasien"
                        fgroup-class="col-md-6" igroup-size="sm" placeholder="Kelas Pasien" />
            ...
            <div class="col-md-6">
                ...
                <x-adminlte-select igroup-size="sm" name="cara_masuk" label="Cara Masuk" enable-old-support>
