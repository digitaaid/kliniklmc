                ...
                @if ($antrian->pasien->fileuploads)
                    ...
                    <div class="row">
                        @foreach ($antrian->pasien->fileuploads as $file)
                            <div class="col-md-6">
                                <x-adminlte-card header-class="p-2" body-class="p-0" title="{{ $file->nama }}"
                                    theme="secondary" icon="fas fa-file" collapsible="">
            ...
            @else
                @foreach ($antrian->fileuploads as $file)
                    <x-adminlte-card header-class="p-2" body-class="p-0"
                        title="{{ $file->nama }} {{ $file->created_at }}" theme="info" icon="fas fa-file"
