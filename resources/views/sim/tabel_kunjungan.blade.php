            ...
            <form action="{{ route('editkunjungan') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <x-adminlte-input-date fgroup-class="col-md-6" name="tgl_masuk"
                                igroup-size="sm" label="Tanggal Masuk" enable-old-support
                            ...
                            <x-adminlte-select igroup-size="sm" fgroup-class="col-md-6"
                                name="jaminan" label="Jaminan Pasien" enable-old-support >
                        ...
                        <div class="row">
                            ...
                            <x-adminlte-input name="nik" class="nik-id" enable-old-support
                            ...
                            <x-adminlte-input name="penjamin" class="penjamin-id" enable-old-support
                    ...
                    <div class="col-md-6">
                        ...
                        <x-adminlte-select2 igroup-size="sm" name="diagnosa_awal" enable-old-support
                        ...
                        <x-adminlte-select igroup-size="sm" name="jeniskunjungan" enable-old-support
