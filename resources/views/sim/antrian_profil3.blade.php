    <div class="row">
        ...
        <div class="col-md-4">
            <dl class="row">
                ...
                <dt class="col-sm-4 m-0">Farmasi</dt>
                <dd class="col-sm-8 m-0">
