                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-adminlte-input name="denyut_jantung" label="Denyut Jantung" igroup-size="sm" type="number"
                                placeholder="Denyut Jantung" fgroup-class="row" label-class="text-left col-5"
                        ...
                        <div class="col-md-6">
                            ...
                            <x-adminlte-input name="bsa" class="bsainput" label="Index BSA (m2)" fgroup-class="row"
                                label-class="text-left col-5" igroup-size="sm" igroup-class="col-7" igroup-size="sm"
...
@can('perawat')
    <x-adminlte-modal id="modalAnamnesaPerawat" title="Anamnesa Perawat Rajal" size="xl" icon="fas fa-file-medical"
        theme="success">
        <form action="{{ route('editasesmenperawat') }}" name="formPerawat" id="formPerawat" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <x-adminlte-textarea igroup-size="sm" rows=2 label="Riwayat Penyakit Dahulu" name="riwayat_penyakit"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <x-adminlte-input name="bsa" class="bsainput" label="Index BSA (m2)" fgroup-class="row"
                        label-class="text-left col-5" igroup-size="sm" igroup-class="col-7" igroup-size="sm"
                        placeholder="Index BSA (m2)" value="{{ $antrian->asesmenperawat->bsa ?? null }}" readonly>
                        <x-slot name="appendSlot">
                            <div class="input-group-text bg-secondary">
                                kg/m2
                            </div>
                    ...
                    <x-adminlte-textarea igroup-size="sm" rows=4 label="Pemeriksaan Fisik Perawat" name="keadaan_tubuh"
        ...
        <x-slot name="footerSlot">
            <button type="submit" form="formPerawat" class="btn btn-success withLoad">
...
@push('js')
    ...
    <script>
        ...
        function modalAnamnesaPerawat() {
            $.LoadingOverlay("show");
            $('#modalAnamnesaPerawat').modal('show');
            $.LoadingOverlay("hide");
        }
