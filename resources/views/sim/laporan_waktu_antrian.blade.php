...
@section('title', 'Laporan Waktu Antrian')
@section('content_header')
    <h1>Laporan Waktu Antrian</h1>
@stop
@section('content')
    <div class="row">
        <div class="col-md-12">
        ...
        @if (isset($antrians))
            <div class="col-md-12">
                ...
                <x-adminlte-card title="Data Antrian Pendaftaran" theme="warning" icon="fas fa-info-circle" collapsible>
                    ...
                    @php
                        $heads = ['No', 'Tanggal', 'Kodeboking', 'Pasien', 'Taskid 1', 'Taskid 2', 'Taskid 3', 'Taskid 4', 'Taskid 5', 'Taskid 6', 'Taskid 7', 'Status'];
                        $config['order'] = [1, 'asc'];
                        $config['paging'] = false;
